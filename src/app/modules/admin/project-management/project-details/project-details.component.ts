...
import { ClientType, ProjectType, ProjectTypeName, ProjectName, LegalAdvice } from 'src/app/services/enums/client';
...
export class ProjectDetailsComponent implements OnInit {
  ...
  isHaveOtherProjectName: boolean = true;
  isOtherLegalAdviceName: boolean = true;
  ...
  getProjectDetails() {
    ...
    this.service.GetProjectDetails(this.projectId).pipe(finalize(() => {
      ...
      console.log(this.selectedDutyDataList)
    })
  }
