...
@Component({
  selector: 'app-simplified-invoice-pdf',
  templateUrl: './simplified-invoice-pdf.component.html',
  styleUrls: ['./simplified-invoice-pdf.component.scss']
})
export class SimplifiedInvoicePdfComponent implements OnInit {

  @Input() PriceToProjectDetails: any;
  ...
  ngOnInit(): void {
    console.log(this.PriceToProjectDetails);
