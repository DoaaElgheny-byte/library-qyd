...
@Component({
  selector: 'app-payment-notice-pdf',
  templateUrl: './payment-notice-pdf.component.html',
  styleUrls: ['./payment-notice-pdf.component.scss']
})
export class PaymentNoticePdfComponent implements OnInit {
